...
var incompleteTaskHolder=document.getElementById("task-list_incomplete");//ul of #task-list_incomplete
var completedTasksHolder=document.getElementById("task-list_completed");//#task-list_completed
...
//Mark task as incomplete.
  ...
  //Append the task list item to the #incomplete-t  asks.
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
}
